        ...
        - generic [ref=f2e87]:
          ...
          - generic [ref=f2e91]:
            - generic [ref=f2e92]:
              ...
              - textbox "E-Mail Address" [ref=f2e94]: qatesting491@gmail.com
            - generic [ref=f2e95]:
              - generic [ref=f2e96]: Password
              - textbox "Password" [ref=f2e97]: PAKISTAn@123
...
```ts
  ...
  7  | 
  8  | //Load json test data from the file  logindata json 
  9  | 
  10 | const JsonPath = "TestData/loginData.json";
  11 | 
  12 | const JsonTestData = DataProvider.getTesdtDataFromJson(JsonPath);
  13 | 
  ...
  33 |             const isLoggedIn=await myAccountPage.isMyAccountPageExist();
